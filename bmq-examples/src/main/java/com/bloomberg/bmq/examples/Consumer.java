...
/**
 * Sample application which connects to BlazingMQ broker and consumes messages. Part of the BlazingMQ
 * tutorial.
 *
 ...
 * </ul>
 *
 * <p>In order to consume messages, {@code Consumer} class implements {@link
 * com.bloomberg.bmq.PushMessageHandler} interface. When new messages are being delivered from the
 * queue, {@link #handlePushMessage} method is called.
 *
 * <p>Also, {@code Consumer} implements {@link com.bloomberg.bmq.SessionEventHandler} and {@link
