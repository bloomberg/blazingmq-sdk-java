...
/** Interface to the Session that provides access to the BMQ broker */
public interface AbstractSession {

    /**
     * Connect to the BMQ broker and start the message processing
     *
    ...
    /**
     * Gracefully disconnect from the BMQ broker and stop the operation of this 'Session'.
     *
