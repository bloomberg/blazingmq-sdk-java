 ...
 *
 * <p>{@code MessageGUID} provides a value-semantic global unique identifier for BlazingMQ messages.
 * Each message delivered to BlazingMQ client from BlazingMQ broker contains a unique {@code
 * MessageGUID}.
 *
