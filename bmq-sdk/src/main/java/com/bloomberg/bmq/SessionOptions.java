 ...
 *       watermarks on the channel. Default value for high watermark is 64MB. Note that BMQ reserves
 *       4MB of this value for control message, so the actual watermark for data published is
 *       'HighWatermark - 4MB'. Default value for low watermark is 1MB.
...
public final class SessionOptions {
    ...
    /**
     * Returns an object which monitors the health of the host. BMQ sessions can use such objects to
     * conditionally suspend queue activity while the host is marked unhealthy. Default value is
     * null that means no monitor is set.
     *
