...
/**
 * Provides value-semantic type and utilities for a BMQ queue URI.
 *
 * <p>This class provides a value-semantic type, representing a URI for a BMQ queue. A {@code Uri}
 * can be built by parsing from a string representation provided to the class constructor.
 *
 * <H2>URI format</H2>
 *
 * In a nutshell, a URI representing an application queue managed by a BMQ broker on a given machine
 ...
 *   <li>The URI authority is the name of BMQ domain (such as "ts.trades.myapp") as registered with
 *       the BMQ infrastructure. The domain name may contain alphanumeric characters, dots and
 *       dashes (it has to match the following regular expression: {@code [-a-zA-Z0-9\\._]+'}. The
 *       domain may be followed by an optional tier, introduced by the ".~" sequence and consisting
 *       of alphanumeric characters and dashes. The ".~" sequence is not part of the tier.
 ...
 *       id}, and corresponding value represents a name that will be used by BMQ broker to uniquely
 *       identify the client.
...
public class Uri {
    ...
    /**
     * Returns {@code qualifiedDomain} part of the URI in terms of the BMQ terminology.
     *
    ...
    /**
     * Returns {@code domain} part of the URI in terms of the BMQ terminology.
     *
    ...
    /**
     * Returns {@code tier} part of the URI in terms of the BMQ terminology.
     *
    ...
    /**
     * Returns {@code queue} part of the URI in terms of the BMQ terminology.
     *
    ...
    /**
     * Returns {@code id} part of the URI in terms of the BMQ terminology.
     *
