...
public class ProtocolEventImplTcpReaderTest {
    ...
    public void testIODump() throws IOException, InterruptedException {
        ...
        // Check that ProtocolEventTcpReader correctly reads BMQ events
        // stored in IO dump file.
        // Steps:
        // 1. Read dump file and feed ProtocolEventTcpReader by portions defined in index file;
        // 2. From ProtocolEventTcpReader callback decode BMQ events and put them into a queue;
    ...
    public void testPartialReading() throws IOException {
        ...
        // Steps:
        // 1. Generate BMQ EventImpl with several PUSH messages;
        ...
        // 4. Check that ProtocolEventTcpReader correctly composes BMQ Events.
