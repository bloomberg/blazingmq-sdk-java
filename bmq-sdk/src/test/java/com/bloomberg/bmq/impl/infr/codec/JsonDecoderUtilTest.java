...
public class JsonDecoderUtilTest {
    ...
    @Test
    public void testDecodeClientIdentity() {
        try {
            ByteBuffer buf =
                    TestHelpers.readFile(MessagesTestSamples.CLIENT_IDENTITY_JSON.filePath());
            ...
            logger.info("IOException while decoding nego msg: ", e);
            fail();
        }
    }

    @Test
    public void testDecodeBrokerResponse() {
        try {
            ByteBuffer buf =
                    TestHelpers.readFile(MessagesTestSamples.BROKER_RESPONSE_JSON.filePath());
            ...
            logger.info("IOException while decoding ctrl msg: ", e);
            fail();
        }
    }

    @Test
    public void testDecodeOpenQueue() {
        try {
            ...
            ControlMessageChoice ctrlChoice =
    ...
    @Test
    public void testDecodeOpenQueueResponse() {
        try {
            ByteBuffer buf =
