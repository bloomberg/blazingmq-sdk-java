...
public class MessagesTestSamples {
    ...
    public static final SampleFileMetadata STATS_EVENTQUEUE_SAMPLE_AFTER_FINAL =
            new SampleFileMetadata("/data/stat_eventqueue_stats_sample_after_final.txt", 381);
