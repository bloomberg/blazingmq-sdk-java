...
public class BrokerSessionIT {
     ...
     *       queue;
     *   <li>Check the number of generated BMQ events - it should be 3 + N
     *   <li>BMQ event #1 should be: e_CONNECTION_LOST;
     *   <li>BMQ event #2 should be: e_RECONNECTED;
     *   <li>BMQ event #[3..N + 2] should be: e_QUEUE_REOPEN_RESULT(E_SUCCESS) with correlation id
     *       present among stored correlation ids of opened queue;
     *   <li>BMQ event #(N + 3) should be: e_STATE_RESTORED
     *   <li>stop broker session.
     * </ul>
     */
