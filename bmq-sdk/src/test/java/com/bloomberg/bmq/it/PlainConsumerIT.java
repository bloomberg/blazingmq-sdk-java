...
public class PlainConsumerIT {
        ...
        try {
            ...
            while (pushIt.hasNext()) {
                ...
                if (props != null) {
                    ...
                    Iterator<Map.Entry<String, com.bloomberg.bmq.impl.infr.proto.MessageProperty>>
                            it = props.iterator();
                    while (it.hasNext()) {
    ...
    public void testConsumer() throws IOException {
        ...
        logger.info("====================================================================");
        logger.info("BEGIN Testing PlainConsumerIT getting message from the BMQ Broker.");
        logger.info("====================================================================");

        try (BmqBroker broker = BmqBroker.createStartedBroker()) {
            final String MSG = "Hello from BMQ JAVA SDK! I'm consumer";
        ...
        logger.info("==================================================================");
        logger.info("END Testing PlainConsumerIT getting message from the BMQ Broker.");
        logger.info("==================================================================");
    }
}
