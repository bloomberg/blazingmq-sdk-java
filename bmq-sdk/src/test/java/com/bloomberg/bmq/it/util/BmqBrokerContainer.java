...
public class BmqBrokerContainer implements BmqBroker {
    ...
    private static Path makeTempDir(String containerName) throws IOException {
        // BMQ brokers running in the docker containers create storage files in the
    ...
    public void start() {
        ...
        // For BMQ broker running in container default tier should be the 'lcl-{guest hostname}'
    ...
    public void close() throws IOException {
        ...
        if (dumpBrokerOutput) {
            logger.info(
                    "Dump BMQ Broker output for '{}' container:\n{}",
                    containerName,
