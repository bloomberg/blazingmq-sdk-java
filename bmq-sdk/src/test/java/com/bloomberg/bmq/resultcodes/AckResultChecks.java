...
public class AckResultChecks {
    ...
    public static void checkExtraPredicates(
            AckResultTest.AckGenericTest test, ResultCodes.AckResult obj) {
        test.isLimitMessages(obj);
        test.isLimitBytes(obj);
        test.isStorageFailure(obj);
    }

    public static void checkGeneric(ResultCodes.AckResult obj) {
        checkExtraPredicates(new AckResultTest.AckGenericTest(), obj);
    }

    public static void checkLimitMessages(ResultCodes.AckResult obj) {
        checkExtraPredicates(new AckResultTest.LimitMessagesTest(), obj);
    }

    public static void checkLimitBytes(ResultCodes.AckResult obj) {
        checkExtraPredicates(new AckResultTest.LimitBytesTest(), obj);
    }

    public static void checkStorageFailure(ResultCodes.AckResult obj) {
